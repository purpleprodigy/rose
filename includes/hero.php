 ...
 * Rose
 *
 * This file adds the hero section to the Rose Theme.
 *
 * @package Rose
...
add_filter( 'genesis_attr_entry', 'rose_entry_attr' );
/**
...
add_action( 'genesis_before', 'rose_hero_section_setup' );
/**
 * Set up hero section.
 *
 ...
 * @return void
 */
function rose_hero_section_setup() {
	...
	add_action( 'rose_hero_section', 'genesis_do_posts_page_heading' );
	add_action( 'rose_hero_section', 'genesis_do_date_archive_title' );
	add_action( 'rose_hero_section', 'genesis_do_taxonomy_title_description' );
	add_action( 'rose_hero_section', 'genesis_do_author_title_description' );
	add_action( 'rose_hero_section', 'genesis_do_cpt_archive_title_description' );
...
add_action( 'genesis_before_content', 'rose_remove_404_title' );
/**
 ...
 * @return void
 */
function rose_remove_404_title() {
...
add_action( 'be_title_toggle_remove', 'rose_genesis_title_toggle' );
/**
 ...
 * @return void
 */
function rose_genesis_title_toggle() {

	remove_action( 'rose_hero_section', 'rose_page_title', 10 );
	remove_action( 'rose_hero_section', 'rose_page_excerpt', 20 );

}

add_action( 'rose_hero_section', 'rose_page_title', 10 );
/**
...
function rose_page_title() {
	...
	if ( class_exists( 'WooCommerce' ) && is_shop() ) {
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'rose_latest_posts_title', __( 'Latest Posts', 'rose' ) ),
			'context' => 'entry-title',
		) );
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'genesis_404_entry_title', __( 'Not found, error 404', 'rose' ) ),
			'context' => 'entry-title',
		) );
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'genesis_search_title_text', __( 'Search results for: ', 'rose' ) ) . get_search_query(),
			'context' => 'entry-title',
		) );
...
add_action( 'rose_hero_section', 'rose_page_excerpt', 20 );
/**
...
add_filter( 'genesis_attr_hero-section', 'rose_hero_section_attr' );
/**
 ...
 * @return array
 */
function rose_hero_section_attr( $attr ) {
...
add_action( 'genesis_before_content_sidebar_wrap', 'rose_hero_section' );
/**
 * Display the hero section.
 *
 * Conditionally outputs the opening and closing hero section markup and runs
 * rose_hero_section which all of our header functions are hooked to.
 *
 * @since  1.0.0
 *
 * @return void
 */
function rose_hero_section() {
	 ...
	 *
	 * @hooked rose_page_title - 10
	 * @hooked rose_page_excerpt - 20
